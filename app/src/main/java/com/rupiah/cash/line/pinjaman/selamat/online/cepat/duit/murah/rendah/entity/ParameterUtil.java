...
public class ParameterUtil {
    ...
    public String getInitJson() {
        ...
        try {
            //内层
            deviceInfo2.put("androidId", CreateUUID.createUUID(mContext));
            ...
            deviceInfo2.put("imei", CreateUUID.createUUID(mContext));
            ...
            deviceInfo2.put("uuid", CreateUUID.createUUID(mContext));
            //中间
